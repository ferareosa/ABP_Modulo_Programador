        ...
        match opcion_menu_principal:
            case 1:
                ...
                match opcion_submenu:
                    case 1:
                        print("Opción 1 seleccionada: Ver Clientes")
                        ver_clientes()
                        opcion_submenu = None
                        continue
                    case 2:
                        print("Opción 2 seleccionada: Agregar Cliente")
                        opcion_submenu = agregar_cliente()
                        continue
                    case 3:
                        print("Opción 3 seleccionada: Modificar Cliente")
                        opcion_submenu = modificar_cliente()
                        continue
                    case 4:
                        print("Opción 4 seleccionada: Eliminar Cliente")
            ...
            case 2:
                ...
                match opcion_submenu:
                    case 1:
                        print("Opción 1 seleccionada: Ver Destinos")
                        ver_destinos()
                        opcion_submenu = None
                        continue
                    case 2:
                        print("Opción 2 seleccionada: Agregar Destino")
                        opcion_submenu = agregar_destino()
                        continue
                    case 3:
                        print("Opción 3 seleccionada: Modificar Destino")
                        opcion_submenu = modificar_destino()
                        continue
                    case 4:
                        print("Opción 3 seleccionada: Cambiar La Disponibilidad Del Destino")
            ...
            case 3:
                ...
                match opcion_submenu:
                    case 1:
                        print("Opción 1 seleccionada: Ver Pasajes Comprados")
                        ver_pasajes()
                        opcion_submenu = None
                        continue
                    case 2:
                        print("Opción 2 seleccionada: Comprar Pasaje")
                        opcion_submenu = compra_de_pasaje()
                        continue
                    case 3:
                        print("Opción 3 seleccionada: Cancelar Pasaje (Boton de Arrepentimiento)")
